                    ...
                    <div className="row">   
                        ...
                        <div className="col-lg-3 col-md-6 mb-5 mb-lg-0">
                            <div className="footer-widget recent-blog">
                                ...
                                <div className="mt-4"><Link to="#" className="text-white">Términos y condiciones</Link></div>
                        ...
                        <div className="col-lg-3 col-md-5 mb-5 mb-lg-0">
                            <div className="footer-icons">
                                <h4 className="mb-4 text-white letter-spacing text-uppercase">Publica acá</h4>
