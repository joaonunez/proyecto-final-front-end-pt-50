                ...
                <tr>
                  <td colSpan="8">
                    <div className="reservation-details-container">
                      ...
                      <p><strong>Camping:</strong> {reservation.camping?.name || reservation.site?.camping_name}</p>
                      <p><strong>Dirección:</strong> {reservation.camping?.address || reservation.site?.camping?.address}</p>
